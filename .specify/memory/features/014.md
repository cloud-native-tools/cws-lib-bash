...
**Status**: Draft  
**Spec Path**: .specify/specs/014-cross-platform-compatibility/spec.md  
**Created**: 2025-12-04  
...
- Specification: .specify/specs/014-cross-platform-compatibility/spec.md
- Feature Index: memory/feature-index.md
- Feature Detail: memory/features/014.md
- Quality Checklist: .specify/specs/014-cross-platform-compatibility/checklists/requirements.md
...
| cross-platform-compatibility | Kebab-case combination of ID + normalized name (e.g., 001-feature-mechanism-redesign) |
...
| Support for both Linux and macOS environments. | Paragraph explaining motivation and context |
