...
# Feature Detail: Kubernetes Operations

**Feature ID**: F003  
**Name**: Kubernetes Operations  
**Description**: Helpers for kubectl, Helm, and cluster management.  
**Status**: Implemented  
**Created**: 2026-02-05  
...
Provides essential shortcuts and helpers for Kubernetes interactions, including `kubectl` context switching, Helm chart management, and Kind cluster setup.
...
- Specification: .specify/specs/F003-[FEATURE_SLUG]/requirements.md
- Feature Index: memory/features.md
- Feature Detail: memory/features/F003.md
- Quality Checklist: .specify/specs/F003-[FEATURE_SLUG]/checklists/requirements.md
...
|-------|------------------|
| F003 | Sequential three-digit feature identifier (e.g., 001) |
| Kubernetes Operations | Short human-readable name (2-5 words) |
| [FEATURE_SLUG] | Kebab-case combination of ID + normalized name (e.g., 001-feature-mechanism-redesign) |
| Helpers for kubectl, Helm, and cluster management. | One-line summary in natural language |
...
| Provides essential shortcuts and helpers for Kubernetes interactions, including `kubectl` context switching, Helm chart management, and Kind cluster setup. | Paragraph explaining motivation and context |
